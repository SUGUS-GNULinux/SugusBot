...
def main():
    ...
    dispatcher.add_handler(CommandHandler('addevent',
                                          handlers.add_event))
    dispatcher.add_handler(CallbackQueryHandler(handlers.remove_event,
                                                pattern = '^remove_event.'))
    ...
    dispatcher.add_handler(CallbackQueryHandler(handlers.participants,
